#!/bin/bash
# Deploy Offline Sync Worker via Cloudflare REST API
# Termux-compatible (no wrangler)
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
WORKER_NAME="2b-offline-sync"
...
echo ""
echo "NOTE: Worker runs in stub mode. Bind KV in Dashboard for full functionality."
